            ...
            <ScrollView contentContainerStyle={styles.contentParams}>
                <BlurView intensity={20} tint="dark" style={styles.textContent}>
                    <Text style={styles.paragraph}>
                        Bienvenido a DevPal. Al utilizar nuestra aplicación, aceptas cumplir con los siguientes términos y condiciones.
                    </Text>

                    <Text style={styles.heading}>1. Uso de la Aplicación</Text>
                    <Text style={styles.paragraph}>
                        DevPal es una plataforma de gamificación para desarrolladores. Debes usarla de manera responsable y respetuosa con otros usuarios.
                    </Text>

                    <Text style={styles.heading}>2. Cuentas de Usuario</Text>
                    <Text style={styles.paragraph}>
                        Eres responsable de mantener la confidencialidad de tu cuenta y contraseña. Cualquier actividad realizada desde tu cuenta es tu responsabilidad.
                    </Text>

                    <Text style={styles.heading}>3. Propiedad Intelectual</Text>
                    <Text style={styles.paragraph}>
                        Todo el contenido, marcas y logotipos son propiedad de DevPal o sus licenciantes. No puedes utilizarlos sin permiso previo.
                    </Text>

                    <Text style={styles.heading}>4. Modificaciones</Text>
                    <Text style={styles.paragraph}>
